...
static inline void
dt_gui_darkroom_dspy_mouse_position(GLFWwindow* window, double x, double y)
{
...
static inline void
dt_gui_darkroom_dspy_mouse_button(GLFWwindow* window, int button, int action, int mods)
{
  double x, y;
